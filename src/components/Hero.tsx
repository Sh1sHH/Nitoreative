    ...
    <section className="min-h-screen bg-dark flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center lg:justify-end px-6 lg:pr-20 lg:pl-4 py-20 lg:py-0 relative z-20">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/images/texture3_webp.webp" 
            alt="Background Texture" 
            className="w-full h-full object-cover opacity-80"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-dark/40 to-dark/0"></div>
        </div>

        {/* Content */}
        <div className="max-w-2xl relative z-10">
          <div className="flex flex-wrap gap-3 mb-8 lg:mb-12 justify-center lg:justify-start">
            <span className="px-4 py-2 bg-[#332D1B] text-white rounded-full text-sm font-medium hover:bg-[#4C684E]/90 transition-all duration-300 cursor-pointer">branding</span>
            <span className="px-4 py-2 bg-[#332D1B] text-white rounded-full text-sm font-medium hover:bg-[#4C684E]/90 transition-all duration-300 cursor-pointer">graphic design</span>
            <span className="px-4 py-2 bg-[#332D1B] text-white rounded-full text-sm font-medium hover:bg-[#4C684E]/90 transition-all duration-300 cursor-pointer">social media</span>
            <span className="px-4 py-2 bg-[#332D1B] text-white rounded-full text-sm font-medium hover:bg-[#4C684E]/90 transition-all duration-300 cursor-pointer">production</span>
          </div>
          ...
          <h1 className="font-aclonica text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-tight mb-6 lg:mb-8 text-center lg:text-left">
            "Good ideas need<br />
            <span className="text-[#332D1B]">Good People."</span>
          </h1>

          <p className="text-lg lg:text-xl text-gray-100 mb-8 lg:mb-12 leading-relaxed text-center lg:text-left">
          ...
          <div className="flex justify-center lg:justify-start">
            <button className="px-8 py-4 bg-[#332D1B] text-white rounded-lg font-semibold hover:bg-[#4C684E]/90 transition-all duration-300 text-lg">
              Contact Us
            </button>
          </div>
        </div>
